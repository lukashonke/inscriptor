...
const keys = useMagicKeys({
  ...
  onEventFired(e) {
    ...
    if (promptStore.keyboardShortcutsEnabled && e.shiftKey && e.altKey && ((e.key >= '0' && e.key <= '9'))) {
      e.preventDefault()
    }
...
watch(shiftAlt1, (v) => { if (promptStore.keyboardShortcutsEnabled && focusedEditor.value && !v) executePromptByShortcut(1, true); })
watch(shiftAlt2, (v) => { if (promptStore.keyboardShortcutsEnabled && focusedEditor.value && !v) executePromptByShortcut(2, true); })
watch(shiftAlt3, (v) => { if (promptStore.keyboardShortcutsEnabled && focusedEditor.value && !v) executePromptByShortcut(3, true); })
watch(shiftAlt4, (v) => { if (promptStore.keyboardShortcutsEnabled && focusedEditor.value && !v) executePromptByShortcut(4, true); })
watch(shiftAlt5, (v) => { if (promptStore.keyboardShortcutsEnabled && focusedEditor.value && !v) executePromptByShortcut(5, true); })
watch(shiftAlt6, (v) => { if (promptStore.keyboardShortcutsEnabled && focusedEditor.value && !v) executePromptByShortcut(6, true); })
watch(shiftAlt7, (v) => { if (promptStore.keyboardShortcutsEnabled && focusedEditor.value && !v) executePromptByShortcut(7, true); })
watch(shiftAlt8, (v) => { if (promptStore.keyboardShortcutsEnabled && focusedEditor.value && !v) executePromptByShortcut(8, true); })
watch(shiftAlt9, (v) => { if (promptStore.keyboardShortcutsEnabled && focusedEditor.value && !v) executePromptByShortcut(9, true); })
watch(shiftAlt0, (v) => { if (promptStore.keyboardShortcutsEnabled && focusedEditor.value && !v) executePromptByShortcut(0, true); })
